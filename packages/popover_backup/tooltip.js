...
import { getOptions, directive } from "./directive/tooltip";
import addClass from "buxton/browser/addClass";
import removeClass from "buxton/browser/removeClass";
import supportsPassive from "buxton/browser/supportsPassive";
...
export default class Tooltip {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (title.nodeType === 1) {
        ...
        if (result && typeof result.then === "function") {
          ...
          options.loadingClass && addClass(rootNode, options.loadingClass);
          ...
          result
            .then(asyncResult => {
              options.loadingClass &&
                removeClass(rootNode, options.loadingClass);
  ...
  _show(reference, options) {
    ...
    if (this._tooltipNode) {
      addClass(this._tooltipNode, this._classes);
      updateClasses = false;
    }
    ...
    addClass(reference, ["v-tooltip-open"]);
  ...
  _hide(/* reference, options */) {
    ...
    removeClass(this.reference, ["v-tooltip-open"]);
